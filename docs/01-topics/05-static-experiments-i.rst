...
Many experiments fit into this mould, including most of our demos:
...
In this case, the primary identity of the trial comes from the audio file that is played to the participant,
which is determined by ``self.assets["stimulus_audio"]``.
